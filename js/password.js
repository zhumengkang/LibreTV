...
// 硬编码的密码哈希值 (密码: 951951)
const HARDCODED_PASSWORD_HASH = "5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8"; // 951951 的 SHA-256 哈希值

// 模拟环境变量
window.__ENV__ = {
    PASSWORD: HARDCODED_PASSWORD_HASH,
    ADMINPASSWORD: HARDCODED_PASSWORD_HASH  // 如果需要管理员密码也使用相同密码
};
...
console.log('对应的SHA-256哈希值是:', HARDCODED_PASSWORD_HASH);
